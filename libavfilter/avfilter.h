...
typedef struct AVFilter {
    ...
    /**
     * Sanitize formats supported by the filter on its inputs and outputs.
     *
     * This callback is called after query_formats().
     * This callback is used for transfer out_formats(input link) to
     * in_formats(output link).
     *
     * This callback may be called more than once.
     *
     * @return zero if formats no changed, AVERROR(EAGAIN) means formats
     *  changed and should call again.
     *  Other negative value corresponding to an AVERROR code.
     */

    int (*sanitize_formats)(AVFilterContext *);
