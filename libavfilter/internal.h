...
/**
 * Tell if an integer is contained in the provided 0-terminated list of integers.
 *
 * @param rate provided rate
 * @param rates 0-terminated list of rates
 * @return 1 if present, 0 if absent
 */
int ff_rate_is_in(int rate, const int *rates);
