...
#define AVFMT_FLAG_PRIV_OPT    0x20000 ///< Enable use of private options by delaying codec open
...
int avformat_read_header(AVFormatContext *s);
int avformat_read_close(AVFormatContext *s);
