...
extern const AVInputFormat  ff_bluelet_demuxer;
extern const AVOutputFormat ff_bluelet_muxer;
...
extern const AVInputFormat  ff_nuttx_demuxer;
extern const AVOutputFormat ff_nuttx_muxer;
...
extern const AVOutputFormat ff_uorb_muxer;
